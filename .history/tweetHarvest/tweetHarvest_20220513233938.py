...
if __name__ == '__main__':
    ...
    myStream.filter(track=['scott morrison', 'scomo', 'Australian prime minister', 'Daniel Andrews', 'premier of victoria'], 
    locations=[144.698181, -38.500893, 145.258484, -37.627284])
