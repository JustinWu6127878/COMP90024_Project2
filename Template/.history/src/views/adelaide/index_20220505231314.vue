...
const covid = new Covid(5000, 20000, 300, 95, this.piechartData('adel', 'pos'), this.piechartData('adel', 'neu'), this.piechartData('adel', 'neg'));
...
export default {
  ...
  methods: {
    ...
    piechartData(city, senti){
      ...
      // });      
      // conosle.log(result)
      // var senti_data = result[city][senti]
