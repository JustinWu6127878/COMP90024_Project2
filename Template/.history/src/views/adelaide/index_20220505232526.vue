...
const covid = new Covid(5000, 20000, 300, 95, this.piechartData('adel', 'pos'), this.piechartData('adel', 'pos'), this.piechartData('adel', 'neg'));
    ...
    return {
     ...
     barchart5: {
      ...
      wordCloudChart: {
        ...
        happy: this.piechartData('adel', 'pos')
      },
    };
  },
