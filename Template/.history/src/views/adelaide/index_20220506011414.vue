...
const covid = new Covid(5000, 20000, 300, 95, "piechartData(adel,'pos')", "piechartData(adel,'neg')", "piechartData(adel,'neu')");
  ...
  data() {
    return {
      ...
      piechart1: {
        ...
        data: [
          { value: piechartData('adel', 'pos'), name: "Positive" },
          { value: piechartData('adel', 'pos'), name: "Neutral" },
          { value: piechartData('adel', 'pos'), name: "Negative" },
        ],
      },
