  ...
  data() {
    return {
      ...
      barchart1: {
        ...
        ydata1: [covidMel.pos, covidMel.neu, covidMel.pos],
        ydata2: [covid.pos, this.piechartData('bris', 'neu'), this.piechartData('bris', 'neg')],
      ...
      barchart5: {
        ...
        xLabel: { rotate: 0 },
        yAxis: {},
        ydata1: [enagement.male, brisbane.overper * 100],
