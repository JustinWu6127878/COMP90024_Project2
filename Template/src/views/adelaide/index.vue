<template>
  <div class="dashboard-container" >
    <div style="display:flex">
      <div class="dashboard-text1" > <h1>{{adelaide.name}}</h1><p>State: {{adelaide.state}}</p>
      
      </div>

      <div class="dashboard-text2" > <p>Total population:</p>
          <p><b>{{milliFormat(adelaide.pop)}} </b></p>
          <p>Born overseas: </p>
          <p><b>{{milliFormat(adelaide.over)}}</b> </p>
          <p>Age 50+ percentage: <i>{{adelaide.age50 + "%"}}</i> </p>
          <p>Age 60+ percentage: <i>{{adelaide.age65 + "%"}}</i> </p>
          <p>Median annual income: <i>{{"$"+milliFormat(adelaide.income)}}</i></p>
      </div>
    </div>
    ...
    <div class="dashboard-text3" > <h2>Topics</h2> 
      <p> These are three topics for adelaide, VIC.
...
//import adelaidemap from './adelaidemap.jpg'
...
export default {
  ...
  adelaide : new CityOverview("Adelaide", "South Australia", 1359760, 340314, 35.9, 17.6, 48043),
