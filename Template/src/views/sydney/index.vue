<template>
  <div class="dashboard-container" >
    <div style="display:flex">
      <div class="dashboard-text1" > <h1>{{sydney.name}}</h1><p>State: {{sydney.state}}</p>
      
      </div>

      <div class="dashboard-text2" > <p>Total population:</p>
          <p><b>{{milliFormat(sydney.pop)}} </b></p>
          <p>Born overseas: </p>
          <p><b>{{milliFormat(sydney.over)}}</b> </p>
          <p>Age 50+ percentage: <i>{{sydney.age50 + "%"}}</i> </p>
          <p>Age 60+ percentage: <i>{{sydney.age65 + "%"}}</i> </p>
          <p>Median annual income: <i>{{"$"+milliFormat(sydney.income)}}</i></p>
      </div>
    </div>
    ...
    <div class="dashboard-text3" > <h2>Topics</h2> 
      <p> These are three topics for sydney, VIC.
...
//import sydneymap from './sydneymap.jpg'
...
export default {
  ...
  sydney : new CityOverview("Sydney", "New South Wales", 5312163, 1769610, 30.4, 14.0, 51191),
